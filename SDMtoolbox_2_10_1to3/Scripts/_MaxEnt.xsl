...
<xsl:template match="Property">
  <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
   <TR class="sdmgrouping"> 
    ...
    <xsl:choose>
      <xsl:when test='PropertyName="Param24"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                   Other Settings
                </TD>            
    ...
    <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
     <TR valign="top">
      <TD WIDTH='17' onclick="displaymessage(this)">
        ...
        <xsl:choose>                   
          <xsl:when test='PropertyName="Param13" or PropertyName="Param14" or PropertyName="Param15" or PropertyName="Param16" or PropertyName="Param17" or PropertyName="Param21" or PropertyName="Param22" or PropertyName="Param25" or PropertyName="Param26" or PropertyName="Param31" or PropertyName="Param35" or PropertyName="Param40" or PropertyName="Param36" or PropertyName="Param37" or PropertyName="Param38"  or PropertyName="Param39"'> 
