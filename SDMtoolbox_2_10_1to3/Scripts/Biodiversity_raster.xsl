  ...
  <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
   <TR class="sdmgrouping"> 
    <xsl:choose>
      ...
      <xsl:when test='PropertyName="Param3"'>         
    ...
    <xsl:choose>
	  <xsl:when test='PropertyName="Param7"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                    Clip Results By Mask and Join to Single Shapefile
                </TD>            
      </xsl:when>
	  <xsl:when test='PropertyName="Param8"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                    Include Species Observations with Too Few Points to Model
                </TD>            
      </xsl:when>
        ...
        <DIV ID="GEN" STYLE="cursor: hand;">
            ...
            <xsl:for-each select="Property"> 
                <xsl:choose>
                    ...
                    <xsl:when test='not(PropertyName="Param5" or PropertyName="Param7" or PropertyName="Param8" or PropertyName="Param9" or PropertyName="Param10")'>                    
					      <xsl:apply-templates select="." />
                    </xsl:when>
                </xsl:choose>
            </xsl:for-each>
                            ...
                            <TR bgcolor="#E6EBF5"><!--menu-->
                                <TH align="left">
                                   <IMG ID="{PropertyGroupName}Image" SRC="{../../CommonPath}/triangle.gif" ALT="*" ALIGN="MIDDLE" BORDER="0" WIDTH="11" HEIGHT="11"/>
									<SPAN class="sdmgrouping" STYLE="padding-bottom=5">Optional Parameters and Analyses</SPAN>
                                </TH>
                            </TR>
                        </TABLE>
                    </TD>
                            ...
                            <TABLE border="0" cellspacing="1" cellpadding="4" width="90%">
                                <xsl:for-each select="Property"> 
                                    <xsl:choose>                               
										...
										<xsl:when test='PropertyName="Param5" or PropertyName="Param7" or PropertyName="Param8" or PropertyName="Param9" or PropertyName="Param10"'> 
                                            <xsl:apply-templates select="." />
										</xsl:when>
                                    </xsl:choose>
                                </xsl:for-each> 
