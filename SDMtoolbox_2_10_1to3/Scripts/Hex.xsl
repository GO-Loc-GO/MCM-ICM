   ...
   <TR class="sdmgrouping"> 
    ...
    <xsl:choose>
      <xsl:when test='PropertyName="Param2"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                    Hexagon Calculation Type (Check only one box below):
                </TD>            
      </xsl:when>
      <xsl:when test='PropertyName="Param8"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                    Clip hexagons by study area boundaries?
                </TD>            
      </xsl:when>
    </xsl:choose>
    </TR>
    ...
    <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
     <TR valign="top">
      <TD WIDTH='17' onclick="displaymessage(this)">
        ...
        <xsl:choose>                   
          <xsl:when test='PropertyName="Param2" or PropertyName="Param3" or PropertyName="Param4" or PropertyName="Param8"'> 
