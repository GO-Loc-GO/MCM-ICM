...
#-------------------------------------------------------------
import arcpy, os, csv ,arcgisscripting, glob, math##*new
  ...
  for i in theFilesA:
    ...
    if nuMpTS < minJackN and nuMpTS >= minModN:
      ...
      for Bn in BVal.split(';'):
         ...
         myCommandiABLQHPT = myCommandi.replace("TeStCsV",OutTeAB).replace("oUtFoLdEr",OutFiABLQHPT).replace("TrAiNiNgDaT",OutTrAB).replace("FeTuRe2R","nothreshold").replace("BiAsFiLeLoc",OutBfin).replace("eXtRaPaR","")
         #ABC
         ...
         myCommandiABCLQHPT = myCommandiShT.replace("TeStCsV",OutTeABC).replace("oUtFoLdEr",OutFiFINAL).replace("TrAiNiNgDaT",OutTeABC).replace("FeTuRe2R","nothreshold").replace("BiAsFiLeLoc",OutBfin).replace("eXtRaPaR",myCommandExtra).replace("\\","/").replace(NSJpRepsT,"").replace(randTptsT,"")
         #
     ...
     if nuMpTS >= minModN:
      ...
      for Bn in BVal.split(';'):
         ...
         myCommandiABLQHPT = myCommandi.replace("TeStCsV",OutTeAB).replace("oUtFoLdEr",OutFiABLQHPT).replace("TrAiNiNgDaT",OutTrAB).replace("FeTuRe2R","nothreshold").replace("BiAsFiLeLoc",OutBfAB).replace("eXtRaPaR","")
         #AC
         ...
         myCommandiACLQHPT = myCommandi.replace("TeStCsV",OutTeAC).replace("oUtFoLdEr",OutFiACLQHPT).replace("TrAiNiNgDaT",OutTrAC).replace("FeTuRe2R","nothreshold").replace("BiAsFiLeLoc",OutBfAC).replace("eXtRaPaR","")
         #BC
         ...
         myCommandiBCLQHPT = myCommandi.replace("TeStCsV",OutTeBC).replace("oUtFoLdEr",OutFiBCLQHPT).replace("TrAiNiNgDaT",OutTrBC).replace("FeTuRe2R","nothreshold").replace("BiAsFiLeLoc",OutBfBC).replace("eXtRaPaR","")
         #ABC
         gp.AddMessage("Compiling batch code for "+outFoldsp+": Final Optimized Run")
         ...
         myCommandiABCLQHPT = myCommandiShT.replace("TeStCsV",OutTeABC).replace("oUtFoLdEr",OutFiFINAL).replace("TrAiNiNgDaT",OutTeABC).replace("FeTuRe2R","nothreshold").replace("BiAsFiLeLoc",OutBfin).replace("eXtRaPaR",myCommandExtra).replace("\\","/")
         #
         myCommandOLD+=myCommandSp
