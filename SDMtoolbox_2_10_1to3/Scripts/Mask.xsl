   ...
   <TR class="sdmgrouping2"> 
	 ...
	 <xsl:choose>
      <xsl:when test='PropertyName="Param10"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                    Scrub ASCII Headers for MaxEnt?
                </TD>            
      </xsl:when>
    </xsl:choose>
    </TR>
    ...
    <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
     <TR valign="top">
      <TD WIDTH='17' onclick="displaymessage(this)">
        ...
        <xsl:choose>                   
          <xsl:when test='PropertyName="Param2" or PropertyName="Param10"'> 
        ...
        <DIV ID="GEN" STYLE="cursor: hand;">
            ...
            <xsl:for-each select="Property"> 
                <xsl:choose>
                    ...
                    <xsl:when test='not(PropertyName="Param5" or PropertyName="Param6" or PropertyName="Param8" or PropertyName="Param9" or PropertyName="Param10")'>                    
					      <xsl:apply-templates select="." />
                    </xsl:when>
                </xsl:choose>
            </xsl:for-each>
                            ...
                            <TABLE border="0" cellspacing="1" cellpadding="4" width="90%">
                                <xsl:for-each select="Property"> 
                                    <xsl:choose>                               
										...
										<xsl:when test='PropertyName="Param5" or PropertyName="Param6" or PropertyName="Param8" or PropertyName="Param9" or PropertyName="Param10"'> 
                                            <xsl:apply-templates select="." />
										</xsl:when>
                                    </xsl:choose>
                                </xsl:for-each> 
