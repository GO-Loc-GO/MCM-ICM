        ...
        <DIV ID="GEN" STYLE="cursor: hand;">
            ...
            <xsl:for-each select="Property"> 
                <xsl:choose>
                    ...
                    <xsl:when test='not(PropertyName="Param7" or PropertyName="Param8" or PropertyName="Param9")'>                    
					      <xsl:apply-templates select="." />
                    </xsl:when>
                </xsl:choose>
            </xsl:for-each>
                            ...
                            <TABLE border="0" cellspacing="1" cellpadding="4" width="90%">
                                <xsl:for-each select="Property"> 
                                    <xsl:choose>                               
										...
										<xsl:when test='PropertyName="Param7" or PropertyName="Param8" or PropertyName="Param9"'> 
                                            <xsl:apply-templates select="." />
										</xsl:when>
                                    </xsl:choose>
                                </xsl:for-each> 
