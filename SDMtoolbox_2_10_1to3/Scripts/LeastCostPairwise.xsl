  ...
  <TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" WIDTH="100%">
   <TR class="sdmgrouping"> 
    <xsl:choose>
      ...
      <xsl:when test='PropertyName="Param4"'>         
    ...
    <xsl:choose>
      <xsl:when test='PropertyName="Param14"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                    Create Least-Cost-Path Lines
                </TD>            
      </xsl:when>
    </xsl:choose>
    <xsl:choose>
      <xsl:when test='PropertyName="Param8"'>         
                <!-- <TD style="padding-top=15"> -->
                <TD style="padding-bottom=5">
                    LCC Class Percentages (input values are integers, e.g. 1% = 1)
                </TD>            
      </xsl:when>
    </xsl:choose>
    <xsl:choose>
        ...
        <DIV ID="GEN" STYLE="cursor: hand;">
            ...
            <xsl:for-each select="Property"> 
                <xsl:choose>
                    ...
                    <xsl:when test='not(PropertyName="Param7" or PropertyName="Param8" or PropertyName="Param9" or PropertyName="Param10" or PropertyName="Param11" or PropertyName="Param12" or PropertyName="Param13")'>                    
					      <xsl:apply-templates select="." />
                    </xsl:when>
                </xsl:choose>
            </xsl:for-each>
                            ...
                            <TR bgcolor="#E6EBF5"><!--menu-->
                                <TH align="left">
                                   <IMG ID="{PropertyGroupName}Image" SRC="{../../CommonPath}/triangle.gif" ALT="*" ALIGN="MIDDLE" BORDER="0" WIDTH="11" HEIGHT="11"/>
									<SPAN class="sdmgrouping" STYLE="padding-bottom=5">Optional Parameters</SPAN>
                                </TH>
                            </TR>
                        </TABLE>
                    </TD>
                            ...
                            <TABLE border="0" cellspacing="1" cellpadding="4" width="90%">
                                <xsl:for-each select="Property"> 
                                    <xsl:choose>                               
										...
										<xsl:when test='PropertyName="Param7" or PropertyName="Param8" or PropertyName="Param9" or PropertyName="Param10" or PropertyName="Param11" or PropertyName="Param12" or PropertyName="Param13"'> 
                                            <xsl:apply-templates select="." />
										</xsl:when>
                                    </xsl:choose>
                                </xsl:for-each> 
