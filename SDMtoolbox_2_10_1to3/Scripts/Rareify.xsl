   ...
   <TR class="sdmgrouping2"> 
    <xsl:choose>
      <xsl:when test='PropertyName="Param9"'>         
                ...
                <TD style="padding-bottom=5">
                    The following options rarefy at different distances based on input habitat heterogeneity
                </TD>            
      </xsl:when>
     </xsl:choose>
    </TR>
        ...
        <DIV ID="GEN" STYLE="cursor: hand;">
            ...
            <xsl:for-each select="Property"> 
                <xsl:choose>
                    ...
                    <xsl:when test='not(PropertyName="Param9" or PropertyName="Param10" or PropertyName="Param11" or PropertyName="Param12" or PropertyName="Param13" or PropertyName="Param14")'>                    
					      <xsl:apply-templates select="." />
                    </xsl:when>
                </xsl:choose>
            </xsl:for-each>
                            ...
                            <TABLE border="0" cellspacing="1" cellpadding="4" width="90%">
                                <xsl:for-each select="Property"> 
                                    <xsl:choose>                               
										...
										<xsl:when test='PropertyName="Param9" or PropertyName="Param10" or PropertyName="Param11" or PropertyName="Param12" or PropertyName="Param13" or PropertyName="Param14"'> 
                                            <xsl:apply-templates select="." />
										</xsl:when>
                                    </xsl:choose>
                                </xsl:for-each> 
